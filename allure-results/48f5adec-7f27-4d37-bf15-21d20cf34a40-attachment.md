...
Call log:
  - waiting for locator('//button[@id=\'showInput\']')
    - locator resolved to <button type="button" id="showInput" class="mt-20 mb-10 bg-lambda-900 hover:bg-transparent hover:text-lambda-900 border border-lambda-900 text-white p-10 rounded focus:outline-none w-180">Get Checked Value</button>
          ...
          - generic [ref=e50]:
            ...
            - generic [ref=e53]:
              - generic [ref=e54]:
                ...
                - textbox "Please enter your Message" [active] [ref=e56]: Jerish
