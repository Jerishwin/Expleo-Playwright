...
Locator: locator('//p[@id=\'prompt-demo\']')
Expected substring: "Maja pa maja pa"
Received string:    ""
Timeout: 5000ms

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for locator('//p[@id=\'prompt-demo\']')
    11 × locator resolved to <p id="prompt-demo" class="ml-10 mb-20 mt-20"></p>
       - unexpected value ""
...
> 64 |     await expect(msg).toContainText("Maja pa maja pa");
     |                       ^ Error: expect(locator).toContainText(expected) failed
  65 |     console.log(msg.textContent());
  66 | 
  67 | });
  68 | 
  69 | 
