...
- Name: testmu.test.ts >> dropdown select
- Location: tests\testmu.test.ts:69:1
          ...
          - generic [ref=e50]:
            ...
            - generic [ref=e52]:
              - combobox [ref=e53]:
                ...
                - option "Wednesday"
                - option "Thursday"
                - option "Friday" [selected]
                - option "Saturday"
              - paragraph [ref=e54]: Day selected :- Friday
          - generic [ref=e55]:
...
```ts
  ...
  74 | 
> 75 |     await page.selectOption('multi-select',[{label:'Texas'},{value:'New Jersey'},{index:2}])
     |                ^ Error: page.selectOption: Test timeout of 30000ms exceeded.
