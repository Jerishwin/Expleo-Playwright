...
Call log:
  - waiting for locator('#sum1')
    - locator resolved to <input id="sum1" type="text" placeholder="Please enter first value" class="border border-gray-550 w-full h-35 rounded px-10"/>
  - elementHandle.type("20")
...
- generic [active] [ref=e1]:
  ...
  - iframe [ref=e383]:
    - article "Server Not Found" [ref=f2e3]:
      - img "Illustration of a fox looking at disconnected network cables." [ref=f2e5]
      - generic [ref=f2e7]:
        - heading "Server Not Found" [level=1] [ref=f2e8]
        - paragraph [ref=f2e9]:
          - text: Nightly can’t connect to the server at
          - strong [ref=f2e10]: consentcdn.cookiebot.com
        - generic [ref=f2e11]:
          - heading "What can you do about it?" [level=3] [ref=f2e12]
          - paragraph [ref=f2e13]: Try connecting on a different device. Check your modem or router. Disconnect and reconnect to Wi-Fi.
        - paragraph [ref=f2e14]:
          - link "Learn more…" [ref=f2e15] [cursor=pointer]:
            - /url: https://support.mozilla.org/1/firefox/151.0/WINNT/en-US/server-not-found-connection-problem
        - button "Try Again" [ref=f2e18]:
          - generic [ref=f2e20]:
            - generic: Try Again
  - alert [ref=e384]
...
```ts
  ...
  15 |     await page.goto("https://www.testmuai.com/selenium-playground/simple-form-demo/",{waitUntil:'networkidle'});
  16 |     const a = 20;
  17 |     const b = 30;
